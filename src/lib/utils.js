...
export const getRandomColor = () => {
  const colorNames = Object.keys(COLORS); // Get array of the keys (color names) ["green", "orange", "red"]
  const randomIndex = Math.floor(Math.random() * colorNames.length); // Get a random index 0 1 2
